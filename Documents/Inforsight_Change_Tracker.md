...
| R2-10 | Phase 2R — Evaluation data | Rebuild v3 folds, features, preprocessing, diagnostics, candidates, selection, and authorization. | Merge pending | [#59](https://github.com/anilreddy89/Inforsight/issues/59) | TBD | 2026-08-30 | — | Simulator `3.1.0`; evaluation `3.2.0`; protocol `2.2.0`; all folds pass; XGBoost selected | Issue [#61](https://github.com/anilreddy89/Inforsight/issues/61) remediates arrears in a separate namespace. Historical 3.0 and invalidated 3.1 evidence remain immutable; no acceptance result or final holdout. |
| R2-11 | Phase 2R — Evidence gate | Run acceptance protocol `2.2.0` after readiness passes. | Pending | TBD | TBD | After R2-10 merge | — | Multi-seed controls, recovery, uncertainty, robustness, and decision evidence | Only merged `proceed` resumes P2-08/P2-09; claims remain limited to role-isolated synthetic recovery. |
...
| Next implementation increment | Merge R2-10, then open R2-11 protocol `2.2.0` execution |
