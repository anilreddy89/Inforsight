...
| RH-08D | Review hardening | Define structured grounding and bounded narrative contract. | In progress | [#165](https://github.com/anilreddy89/Inforsight/issues/165) | TBD | 2026-09-16 | — | [RH-08D contract](../../docs/hardening/rh-08-structured-grounding-contract.md), phase document, `docs/backlog.md` | Design-only change; RH-08I remains blocked until RH-08D merges. Preserve historical artifacts and keep external providers disabled. |
| RH-08I–RH-10 | Review hardening | Implement bounded narratives, P4-contract, and durable-audit repairs. | Planned | TBD | TBD | TBD | — | `docs/backlog.md` Review hardening initiative | Work follows its declared predecessors. Preserve historical artifacts. |
...
| In-progress changes | 1 (RH-08D design, issue #165) |
