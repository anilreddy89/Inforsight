...
| P2-08 | Phase 2 — Baseline ML | Fit probability calibration on designated non-test calibration data and evaluate operational decision thresholds. | In progress | [#96](https://github.com/anilreddy89/Inforsight/issues/96) | TBD | In progress | — | Calibration pipeline, reliability diagrams, Brier score, threshold trade-off tables, false-positive cost assumptions | Resumed Phase 2 work actively in progress on branch `feat/96-p2-08-probability-calibration` following merged mechanical proceed in R2-16A (PR #95); final release holdout remains strictly not_materialized. |
