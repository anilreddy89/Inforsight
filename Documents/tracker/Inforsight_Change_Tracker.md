...
| P4-03 | Phase 4 — Enterprise Integration & Scale | Java 21 / Spring Boot control plane microservice. | Planned — issue pending | TBD | TBD | TBD | — | `services/control-plane/`, Spring Boot 3 app, Virtual Threads, rules engine port, [phase document](../phase_docs/phase-04-03-java-spring-control-plane.md) | RH-13 recorded `PROCEED`; P4-02 is merged. Create the implementation issue and branch from updated `main`. |
...
| Active increment | P4-03 issue preparation |
