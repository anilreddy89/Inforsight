...
| P2-08 | Phase 2 — Baseline ML | Fit probability calibration on designated non-test calibration data and evaluate operational decision thresholds. | Ready to start | TBD | TBD | After R2-16A | — | Calibration pipeline, reliability diagrams, Brier score, threshold trade-off tables, false-positive cost assumptions | Resumed Phase 2 work unpaused following merged mechanical proceed in R2-16A (PR #95); final release holdout remains strictly not_materialized. |
