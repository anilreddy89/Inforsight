...
| P4-06 | Phase 4 — Enterprise Integration & Scale | Cloud infrastructure, Helm charts, and container orchestration. | Planned | [#192](https://github.com/anilreddy89/Inforsight/issues/192) | TBD | 2026-09-20 | — | [phase document](../phase_docs/phase-04-06-cloud-infrastructure-helm-and-orchestration.md), `infra/docker/`, `infra/helm/inforsight`, `infra/docker-compose.yml` | Multi-stage Docker containerization, bounded local Docker Compose orchestration, and renderable Kubernetes Helm configuration with probes, resources, and HPA. Production cloud deployment, credentials, live external execution, and scale claims remain out of scope. Blocks P4-07. |
...
| Active increment | P4-06 planned through issue #192 |
