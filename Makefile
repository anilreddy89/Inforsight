...
# Opt-in Linux-network diagnostic. Requires the P4-06 Compose services in
# OrbStack and a local Maven dependency cache; this is not the E2 release gate.
p4-07-linux-latency-check:
	$(PYTHON) scripts/run_p4_07_local_latency.py --linux-container --target-p99-ms 50
