...
| P3-05 | Phase 3 | Bounded case intelligence assistant | In progress | Issue #116 pending; phase doc prepared in `Documents/phase_docs/phase-03-05-bounded-case-intelligence-assistant.md`. Implementing deterministic template foundation, grounded narrative layer, and grounding guard. |
