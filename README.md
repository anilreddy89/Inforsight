...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-09 are merged. R2-07 recorded `stop` before model fitting because v2 behavior features could include values from events ingested after the observation cutoff. R2-08 [issue #53](https://github.com/anilreddy89/Inforsight/issues/53) and [PR #54](https://github.com/anilreddy89/Inforsight/pull/54) approved the replacement event-first, dual-time, matched-control v3 substrate and protocol `2.0.0`; R2-09 [issue #56](https://github.com/anilreddy89/Inforsight/issues/56) and [PR #57](https://github.com/anilreddy89/Inforsight/pull/57) implemented its 14,400-policy corpus, 76,545 recurring observations, exact oracle sidecars, identities, lineage, and matched streams. R2-10 is ready to begin from updated `main`; R2-11 remains dependency-gated, the final holdout remains `not_materialized`, and P2-08/P2-09 remain paused until a merged R2-11 decision records `proceed`.
