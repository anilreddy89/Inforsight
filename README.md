...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-06 are complete. R2-07 is implemented locally under [issue #51](https://github.com/anilreddy89/Inforsight/issues/51) as a fail-closed readiness gate. Its deterministic evidence records `stop` before model fitting because v2 behavior features can include values from events ingested after the observation cutoff; independent matched-control, specification, and fold-support checks also require redesign. The final holdout remains `not_materialized`. P2-08 probability calibration and P2-09 explanations remain paused, and a focused corrective/versioned-redesign issue is required before statistical acceptance can resume.
