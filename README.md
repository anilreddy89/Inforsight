...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 status reconciliation completed through [PR #30](https://github.com/anilreddy89/Inforsight/pull/30), and R2-01 exact generator configuration, provenance, and namespaced run identity completed through [issue #33](https://github.com/anilreddy89/Inforsight/issues/33) and [PR #34](https://github.com/anilreddy89/Inforsight/pull/34). R2-02 structural and semantic observation invariants is implemented locally for [issue #36](https://github.com/anilreddy89/Inforsight/issues/36); PR and merge are pending. P2-08 probability calibration and P2-09 explanations remain paused until R2-07 merges with a `proceed` decision.
