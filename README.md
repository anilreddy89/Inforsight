...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-12 are merged. R2-08 [issue #53](https://github.com/anilreddy89/Inforsight/issues/53) remains the historical v3 design anchor. R2-11 [issue #64](https://github.com/anilreddy89/Inforsight/issues/64) and [PR #65](https://github.com/anilreddy89/Inforsight/pull/65), merge `76c8cd3`, record mechanical `redesign`. R2-12 [issue #66](https://github.com/anilreddy89/Inforsight/issues/66) and [PR #67](https://github.com/anilreddy89/Inforsight/pull/67), merge `ea9cf1f`, freeze bounded diagnostics. R2-13 [issue #69](https://github.com/anilreddy89/Inforsight/issues/69) is implemented locally: all 20 development seeds diagnose weak observable-oracle separation and weak rolling-payment support, and ADR 0007 freezes v4 substrate `4.0.0` and protocol `3.0.0`. PR review, hosted CI, merge, and issue closeout remain. The final holdout remains `not_materialized`, P2-08/P2-09 remain paused, and downstream performance-dependent work remains blocked.
