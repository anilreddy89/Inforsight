...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active planned remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-07 will reconcile status, repair correctness, introduce a separately versioned statistical corpus, rebuild evaluation data and baselines, and run a predeclared multi-seed acceptance protocol. P2-08 probability calibration and P2-09 explanations are paused until R2-07 merges with a `proceed` decision.
