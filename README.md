...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 status and governance reconciliation completed through [PR #30](https://github.com/anilreddy89/Inforsight/pull/30); [R2-01 issue #33](https://github.com/anilreddy89/Inforsight/issues/33) is now implementing exact generator configuration, provenance, and namespaced run identity. P2-08 probability calibration and P2-09 explanations remain paused until R2-07 merges with a `proceed` decision.
