...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-09 are merged; R2-08 issue #53 approved the v3 design and R2-09 issue #56 implemented its historical corpus. R2-10 local implementation is complete under issues #59–#61: historical failed evidence is retained, the separately versioned arrears correction feeds governed evaluation `3.2.0`, all folds pass, and the deterministic selection rule freezes XGBoost. Merge and hosted CI remain required before R2-10 closes or R2-11 executes protocol `2.2.0`. The final holdout remains `not_materialized`, and P2-08/P2-09 remain paused until a merged R2-11 decision records `proceed`.
