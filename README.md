...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-07 are merged. R2-07 recorded `stop` before model fitting because v2 behavior features can include values from events ingested after the observation cutoff; independent matched-control, specification, and fold-support checks also require redesign. R2-08 under [issue #53](https://github.com/anilreddy89/Inforsight/issues/53) now predeclares a separate event-first, dual-time, matched-control v3 substrate and acceptance protocol `2.0.0`; it produces no v3 data or statistical result. R2-09 through R2-11 remain dependency-gated, the final holdout remains `not_materialized`, and P2-08/P2-09 remain paused until a merged R2-11 decision records `proceed`.
