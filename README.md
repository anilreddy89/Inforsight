...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-04 are complete through PRs #30, #34, #37, #40, and #43. R2-05 v2 corpus implementation completed through [issue #45](https://github.com/anilreddy89/Inforsight/issues/45) and [PR #46](https://github.com/anilreddy89/Inforsight/pull/46), merge commit `25c370d`. R2-06 chronological evaluation data, features, and baselines is next. The final holdout remains `not_materialized`, and P2-08 probability calibration and P2-09 explanations remain paused until R2-07 merges with a `proceed` decision.
