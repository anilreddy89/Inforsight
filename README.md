...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. Historical R2-08 issue #53 remains the v3 design anchor, and R2-11 records the failed v3 acceptance. R2-00 through R2-14B are merged; R2-14B [issue #78](https://github.com/anilreddy89/Inforsight/issues/78) and [PR #79](https://github.com/anilreddy89/Inforsight/pull/79), merge `3088c4c`, records the fail-closed readiness stop `stop_contract_not_executable` under accepted ADR 0009 because contract `1.0.0` lacked mechanical disposition thresholds. Phase 2R.14BA [issue #80](https://github.com/anilreddy89/Inforsight/issues/80) is active under proposed ADR 0010 to approve amended contract `1.1.0`, which freezes quantitative disposition truth tables before successor increment Phase 2R.14BB executes diagnostics on unspent seeds `20280101..20280120`. R2-14C and downstream work remain blocked; reserved acceptance and final holdout remain `not_materialized`.
