...
[Phase 2R](docs/backlog.md#phase-2r---modeling-foundation-remediation-gate) is the active remediation gate inside the [**v0.2.0-risk-model**](https://github.com/anilreddy89/Inforsight/milestone/3) milestone. R2-00 through R2-10 are merged; R2-08 issue #53 and R2-09 issue #56 remain the historical design/corpus traceability anchors. R2-10 [PR #62](https://github.com/anilreddy89/Inforsight/pull/62), merge `36c17b7`, retains historical failed evidence, implements the separately versioned arrears correction and governed evaluation `3.2.0`, proves all folds pass, and freezes XGBoost through deterministic selection. R2-11 [issue #64](https://github.com/anilreddy89/Inforsight/issues/64) is implemented locally with a mechanical `redesign` decision after all 20 pairs pass readiness but signal recovery fails. The final holdout remains `not_materialized`, and P2-08/P2-09 remain paused.
