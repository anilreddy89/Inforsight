...
- [ ] **R2-15 - Freeze replacement evaluation and candidate:** In progress through [issue #90](https://github.com/anilreddy89/Inforsight/issues/90) on branch `feat/90-r2-15-v6-evaluation-and-candidate`. Build governed Generation v6 chronological folds, feature extraction, diagnostics, and deterministic candidate selection, and freeze memberships and fitted-state digests before acceptance access.
