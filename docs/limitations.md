...
| Owner | Historical v2 corpus issue [#56](https://github.com/anilreddy89/Inforsight/issues/56) and later work are complete through merged R2-14 issue #72 and PR #73, which record `redesign`; R2-14A [issue #76](https://github.com/anilreddy89/Inforsight/issues/76) governs the successor diagnostic boundary before R2-15 |
...
| Owner | Historical work is complete through merged R2-14 issue #72 and PR #73, which record `redesign`; R2-14A [issue #76](https://github.com/anilreddy89/Inforsight/issues/76) governs the successor diagnostic boundary before R2-15 |
