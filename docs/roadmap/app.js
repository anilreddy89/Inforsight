  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        status: "Completed",
        commit: "RH-04 04d3e59; RH-05D 3645fae; RH-05I / RH-05 603b955",
        summary: {
      ...
      },
      {
        ...
        commit: "RH-07 complete: PR #164, merge 793217f",
        summary: {
        ...
        checks: "RH-06D issue #160 closed through PR #161 (205f612). RH-06I issue #162 and parent RH-06 closed through PR #163 (df69910) after all six CI checks passed. RH-07 issue #129 closed through PR #164 (793217f): bounded score retention, exact outcome joins, explicit insufficient-data diagnostics, adversarial regressions, and full make check pass. No unsupported monitoring-health claim is accepted."
      },
      {
        id: "RH-08–RH-10",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        status: "Completed",
        commit: "Issue #192; PR #193; merge 974b6a0; poster PR #194",
        summary: {
        ...
        checks: "Issue #192 closed through PR #193, merged as 974b6a0; architecture poster documentation followed in PR #194 as 5c2bf14. Docker images, Compose and Helm render checks, focused infrastructure checks, full local repository validation (546 passed; one optional Kafka integration test skipped), and local service health evidence passed; production cloud deployment and scale claims remain deferred."
      },
      {
        id: "P4-07",
